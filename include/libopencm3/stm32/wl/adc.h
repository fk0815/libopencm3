 ...
 *
 * @brief <b>Defined Constants and Types for the STM32WLxx Analog to Digital Converter</b>
 *
...
/** EOCALIE: End of Calibration Interrupt enable bit */
