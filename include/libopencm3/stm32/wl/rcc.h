 ...
 *
 * @brief <b>Defined Constants and Types for the STM32WLxx Reset and Clock
 * Control</b>
 *
 * @version 1.0.0
 *
...
#define RCC_CFGR_MCO_PLLR			0x5
#define RCC_CFGR_MCO_LSI			0x6
#define RCC_CFGR_MCO_LSE			0x8
#define RCC_CFGR_MCO_PLLP			0xb
#define RCC_CFGR_MCO_PLLQ			0xe
#define RCC_CFGR_MCO_SHIFT			24
#define RCC_CFGR_MCO_MASK			0xf

/* prescaler flags */
#define RCC_CFGR_PPRE2F				(1 << 18)
#define RCC_CFGR_PPRE1F				(1 << 17)
#define RCC_CFGR_HPREF				(1 << 16)
 ...
 * @brief VCO Division factor Q for PLLQCLK clock output [2..8]. Frequency must not exceed 48MHz in voltage range 1
 * @sa rcc_pllcfgr_pllq
 * @{*/
 ...
 * @brief VCO Division factor P for PLLPCLK clock output [2..32]. Frequency must not exceed 48MHz in voltage range 1
 * @sa rcc_pllcfgr_pllp
 * @{*/
 ...
 * @brief Multiplication factor N [8..127] for PLL VCO output frequency. Frequency must be between 96MHz and 344MHz.
 * @{*/
 ...
 * @brief Division factor M [1..8] for PLL input clock. Input frequency must be between 2.66MHz and 16MHz.
 * @{*/
...
#define RCC_AHB3RSTR_IPCCRST			(1 << 20)
...
#define RCC_APB1RSTR1_DACRST			(1 << 29)
...
#define RCC_AHB3ENR_IPCCEN				(1 << 20)
...
#define RCC_APB1ENR1_DACEN				(1 << 29)
...
#define RCC_APB1ENR1_SPI2S2EN			(1 << 14)
...
/** @defgroup rcc_apb3enr_en RCC_APB3ENR enable values
 * @ingroup STM32WLxx_rcc_defines
 *
 * @{*/
...
#define RCC_APB1SMENR1_DACSMEN			(1 << 29)
...
#define RCC_APB1SMENR1_SPI2S2SMEN		(1 << 14)
...
#define RCC_CCIPR_RNGSEL_PLLQCLK	0
...
#define RCC_CCIPR_SPI2S2SEL_PLLQCLK	1
#define RCC_CCIPR_SPI2S2SEL_HSI16	2
#define RCC_CCIPR_SPI2S2SEL_EXT		3
#define RCC_CCIPR_SPI2S2SEL_MASK	0x3
#define RCC_CCIPR_SPI2S2SEL_SHIFT	10
...
#define RCC_CCIPR_UARTxSEL_PCLK		RCC_CCIPR_USARTxSEL_PCLK
...
#define RCC_CSR_RESET_FLAGS	(RCC_CSR_LPWRRSTF | RCC_CSR_WWDGRSTF |\
		...
		RCC_CSR_PINRSTF | RCC_CSR_OBLRSTF | RCC_CSR_RFILARSTF |\
		RCC_CSR_RFRSTF )
...
enum rcc_periph_clken {
	...
	RCC_IPCC = _REG_BIT(RCC_AHB3ENR_OFFSET, 20),
	...
	RCC_DAC = _REG_BIT(RCC_APB1ENR1_OFFSET, 29),
	...
	RCC_SPI2S2 = _REG_BIT(RCC_APB1ENR1_OFFSET, 14),
	...
	/* APB3 peripherals */
	RCC_SUBGHZSPI = _REG_BIT(RCC_APB3ENR_OFFSET, 0),
	...
	SCC_SRAM2 = _REG_BIT(RCC_AHB3SMENR_OFFSET, 24),
	SCC_SRAM1 = _REG_BIT(RCC_AHB3SMENR_OFFSET, 23),
	...
	SCC_DAC = _REG_BIT(RCC_APB1ENR1_OFFSET, 29),
	...
	SCC_SPI2S2 = _REG_BIT(RCC_APB1ENR1_OFFSET, 14),
	...
	SCC_ADC = _REG_BIT(RCC_APB2ENR_OFFSET, 9),

	/* APB3 peripherals in sleep mode */
	SCC_SUBGHZSPI = _REG_BIT(RCC_APB3ENR_OFFSET, 0),
};
...
enum rcc_periph_rst {
	...
	RST_IPCC = _REG_BIT(RCC_AHB3RSTR_OFFSET, 20),
	...
	RST_SPI2S2 = _REG_BIT(RCC_APB1RSTR1_OFFSET, 14),
